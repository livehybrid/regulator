...
ENV_KEYS = [
    ...
    "PORTAINER_HOST", "PORTAINER_TOKEN", "PORTAINER_ENDPOINT",
    "REG_DEFAULT_FLEET", "REG_SWARM_CONSTRAINTS", "REG_WORKER_IMAGE", "REG_BROWSER_WORKER_IMAGE",
    "REG_VUS_PER_WORKER", "REG_PUBLIC_BASE_URL",
]
SECRET_KEYS = {
    "REG_ADMIN_PASSWORD", "REG_API_TOKENS", "REG_HEC_TOKEN",
    "REG_SEED_TARGET_TOKEN", "REG_SEED_TARGET_PASSWORD", "PORTAINER_TOKEN",
}
